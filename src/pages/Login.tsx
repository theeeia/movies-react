...
export default function Login() {
    ...
    const onSubmit = async (values:loginInput) => {         
        ...
        const response = await fetch("https://movies.codeart.mk/api/auth/login",{ ...postReq,
        ...
        setUser({email: data.email, access_token: res.access_token, refresh_token: res.refresh_token, expires_in: addTokenExpire(res.expires_in)})
