...
export default function Register() {
    ...
    const onSubmit =  async (values:registerInput) => { 
        ...
        let response = await fetch("https://movies.codeart.mk/api/auth/register",{ ...postReq,
    ...
    return (
        <>     
            ...
            <Formik 
                innerRef={formRef}
                initialValues={{email:"", password:"", first_name:"", last_name:"",  confirmPassword:"", rememberMe: false}}
